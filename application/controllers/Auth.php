...
class Auth extends CI_Controller
{
    ...
    function index()
    {
        ...
        {
            // redirect them to the dashboard page because they must be an administrator to view this
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!$this->ion_auth->logged_in()) {
                ...
                if (isset($uri2)) {
                    ...
                    $this->data['userid'] = (isset($this->data['userInformation']->id) ? $this->data['userInformation']->id : '');
                }

                $this->_render_page('layouts/header', $this->data);
                $this->_render_page('auth/login', $this->data);
                $this->_render_page('layouts/footer', $this->data);
            } else {
                //if the login is successful
