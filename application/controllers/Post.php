...
class Post extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array("common_model", "profile_model", "admin_model", "term_model"));
    ...
    public function uploadpost() {
        ...
        if (isset($this->data['userid'])) {
            if (!empty($_FILES["upload_media_edit"]) ? $_FILES["upload_media_edit"]["error"] : '' == 4) {
                ...
                (!empty($this->upload->do_upload('upload_media')) ? $this->upload->do_upload('upload_media') : '')  || (!empty($this->upload->do_upload('upload_media_edit')) ? $this->upload->do_upload('upload_media_edit') : '');
