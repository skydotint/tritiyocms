...
<div id="menu-logo">
    <a rel="home" title="Styletex Asia" href="#" class="home-logo">
        <img alt="styletex" src="<?php echo base_url(); ?>frontassets/images/logo.png">
    </a>
...
<div id="page-slider" style="left: -56%;">
    ...
    <div class="column-focus">
        <div class="page-slider-item page-slider-vision" style="opacity: 1;">
            <div class="mask" id="focus_image">
                <img src="<?php echo base_url(); ?>frontassets/images/7.jpg">
            </div>
        </div>
    </div>
</div>
