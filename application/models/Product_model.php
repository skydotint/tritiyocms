...
class Product_model extends CI_Model {
    ...
    private function _insert($product, Array $product_category_ids = array(), Array $product_img_ids = array()) {
        $this->db->insert('products', $product); //product_iserted
    ...
    public function get_product($product_id) {
        $sql = "SELECT id,name,userid,sku,code,price,description,material,color,dimension,delivery_area,delivery_charge,delivery_time,product_image_id ,discount,stricky ," .
    ...
    public function get_products(Array $options = array(), $with_total = false) {
        ...
        $sql = "SELECT id,name,userid,sku,code,price,description,material,color,dimension,delivery_area,delivery_charge,delivery_time,product_image_id ,discount,"
                . " CONCAT(CONCAT(upload_dir,'/',idno), '.', extension) AS product_image "
                . " FROM products LEFT JOIN media_file ON products.product_image_id = media_file.idno "
