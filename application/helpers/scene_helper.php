 ...
 * @return string
 */
function et_footer($cname = NULL) {
    return '<tr>
            <td style="padding: 10px 0 10px 20px; font-family:Helvetica,Arial,sans-serif;  font-size: 12px; color: #FFF; background: #52A028;" bgcolor="#52A028">
                &copy; ' . 2010 . ' <span>' . $cname . '</span>
            </td>
        </tr>
    </table>
    ';
