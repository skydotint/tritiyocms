jQuery(document).ready(function ($) {
    ...
    // ajaxDataFn($,'.add_to_cart','click','add_to_cart','GET');
    ...
    ajaxFn($, '#productUploadForm', 'saveproduct', 'wysiwyg');
    ...
    ajaxFn($, '#addBlockForm', 'insertnewblock', 'blockcontent');
    ...
    ajaxFn($, '#addPageForm', 'insert_page', 'page_content');
    ...
    ajaxImgFn($, '#postUploadForm', 'postupload', 'postcontent');
...
var ajaxUploadFile = function ($, option) {
    ...
    option.success = (option.success === undefined) ? function (data) {} : option.success;
    option.before = (option.before === undefined) ? function (data) {} : option.before;
